    ...
    <div className="releases">
      ...
      <div className="release green">
        ...
        <div className="content">
          ...
          <p className="description">
            CrypBook is the perfect solution for recording crypto transactions.
            It's easy to use and provides the security you need to keep your
            data safe.<a href="#">Free</a>
          </p>
